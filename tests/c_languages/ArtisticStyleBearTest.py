...
class ArtisticStyleBearTest(LocalBearTestHelper):
    ...
    def test_indent_classes(self):
        self.section.append(Setting('attach_braces_to_class', False))
        good_file = ['class Foo\n',
                     '{\n',
                     '    public:\n',
                     '        Foo();\n',
    ...
    def test_indent_cases(self):
        self.section.append(Setting('indent_switches', False))
        self.section.append(Setting('pad_header_blocks', False))
    ...
    def test_indent_namespaces(self):
        self.section.append(Setting('attach_braces_to_class', False))
        self.section.append(Setting('attach_braces_to_namespace', False))
        self.section.append(Setting('indent_namespaces', True))
    ...
    def test_pad_parenthesis(self):
        self.section.append(Setting('pad_header_blocks', False))
        self.section.append(Setting('pad_parenthesis', True))
    ...
    def test_add_braces_to_one_line_conditionals(self):
        self.section.append(Setting('add_braces_to_one_line_conditionals',
                                    True))
        self.section.append(Setting(' pad_header_blocks', False))
        good_file = ['if (isFoo) {\n',
                     '    isFoo = false;\n',
